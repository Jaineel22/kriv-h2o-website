...
import { Star, Zap, Shield, MapPin } from "lucide-react";

const trust = [
  { icon: Star, label: "4.9★ Rated Support" },
  { icon: Zap, label: "Fast Installation" },
  { icon: Shield, label: "AMC Support" },
  { icon: MapPin, label: "Vadodara Service Network" },
];
...
export default function ResidentialHero() {
  return (
    <section className="relative min-h-[80vh] flex items-center overflow-hidden bg-gradient-to-br from-sky-50 via-blue-50/50 to-cyan-50/70">
      {/* Decorative blobs */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute -top-24 -right-24 w-[480px] h-[480px] rounded-full bg-cyan-100/60 blur-3xl" />
        <div className="absolute -bottom-16 -left-16 w-[360px] h-[360px] rounded-full bg-blue-100/50 blur-3xl" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-12 py-20 w-full grid lg:grid-cols-2 gap-14 items-center">
        ...
        <div className="flex flex-col gap-7">
          ...
          >
            Smart purification systems with Alkaline, Copper &amp; Zinc technology
          ...
          >
            ...
            <a
              href="https://wa.me/919999999999?text=I need help choosing a residential RO system"
              target="_blank"
          ...
          <div className="relative w-full max-w-sm">
            <div className="rounded-3xl bg-gradient-to-br from-blue-600 via-cyan-500 to-blue-400 p-1 shadow-2xl shadow-blue-200">
              <div className="rounded-[22px] bg-white/10 backdrop-blur-sm p-6 flex flex-col items-center gap-6">
                {/* Brand Logo Image */}
                <div className="relative w-28 h-28 rounded-full bg-white/20 flex items-center justify-center overflow-hidden">
                  <Image
                    src="/kriv_logo.jpg"
                    alt="Kriv H2O Logo"
                    width={112}
                ...
                <div className="text-center">
                  <p className="text-white font-bold text-xl">Residential Range</p>
                  <p className="text-white/70 text-sm mt-1">4 Premium Models</p>
                </div>
                <div className="flex flex-wrap justify-center gap-2">
                  {["Alkaline", "Copper", "Zinc", "TDS Control"].map((t) => (
                    <span key={t} className="px-3 py-1 rounded-full bg-white/20 text-white text-xs font-medium border border-white/30">
                      {t}
                    </span>
                  ))}
                </div>
            ...
            {/* Floating cards */}
            <div className="absolute -left-10 top-8 bg-white rounded-2xl shadow-xl px-4 py-3 flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-full bg-amber-50 flex items-center justify-center">
                <Star className="w-4 h-4 text-amber-400 fill-amber-400" />
              </div>
              <div>
                <p className="text-slate-900 font-bold text-base leading-none">4.9★</p>
                <p className="text-slate-400 text-xs mt-0.5">Top Rated</p>
              </div>
            </div>
            <div className="absolute -right-10 bottom-10 bg-white rounded-2xl shadow-xl px-4 py-3 flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-full bg-blue-50 flex items-center justify-center">
                <Shield className="w-4 h-4 text-blue-500" />
              </div>
              <div>
                <p className="text-slate-900 font-bold text-base leading-none">AMC</p>
                <p className="text-slate-400 text-xs mt-0.5">Included</p>
              </div>
            </div>
          </div>
        </motion.div>
